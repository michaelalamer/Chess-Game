...
public enum  BoardUtils {
    ...
    // initiate specify column with true
    ...
    // initiate specify row with true
    ...
    // initiate board with variable (a1 , a2 , ......)
    ...
    // check if that move make the king in check or not
    ...
    //  if the front piece is pawn the king can not castle
    ...
    // check if the king can not make other move that mean game over
