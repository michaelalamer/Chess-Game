...
public final class Table extends Observable {
    ...
    private Table() {
        this.gameFrame = new JFrame("MainWidow");
 ...
 //       this.useBook = false;
    ...
    private static class AIThinkTank extends SwingWorker<Move, String> {
        ...
        protected Move doInBackground() throws Exception {
            ...
            //Using StockAlphaBeta algo

            final StockAlphaBeta strategy =
                    new StockAlphaBeta(Table.get().getGameSetup().getSearchDepth() + bonusDepth);

            //Using AlphaBetaWithMoveOrdering algo

//                final AlphaBetaWithMoveOrdering strategy =
//                        new AlphaBetaWithMoveOrdering(Table.get().getGameSetup().getSearchDepth() + bonusDepth , 0);

            //Using IterativeDeepening algo

//                final IterativeDeepening strategy =
//                        new IterativeDeepening(Table.get().getGameSetup().getSearchDepth() + bonusDepth);
